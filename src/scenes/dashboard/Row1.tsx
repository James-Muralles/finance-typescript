  ...
  return (
    ...
    <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <YAxis style={{fontSize: "10px"}} axisLine={{strokeWidth: "0"}} tickLine={false} domain={[8000,23000]}/>
          <Tooltip />
          <Area type="monotone" dataKey="revenue" dot={true} stroke={palette.primary.main} fillOpacity={1} fill="url(#colorExpenses)" />
    ...
    <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <XAxis dataKey="name" style={{fontSize: "10px"}} tickLine={false}/>
          <YAxis yAxisId="left" style={{fontSize: "10px"}} axisLine={false} tickLine={false} />
          ...
          <Line yAxisId="right" type="monotone" dataKey="revenue" stroke={palette.main}/>
          </LineChart>
      </ResponsiveContainer>
    </DashboardBox>
